    ...
    def daily_checklist_config_params
      params
        ...
        .permit(
            ...
            sales_managers_custom_reminder_checklist_items: [:text, :repeat_every, :anchor_date],
            service_managers_custom_reminder_checklist_items: [:text, :repeat_every, :anchor_date],
