class DailyChecklistCreationService
  ...
  def perform!
    ActiveRecord::Base.transaction do
      ...
      create_sales_manager_tasks(checklist)

      create_service_manager_tasks(checklist)
    end
  ...
  private
    def create_sales_manager_tasks(checklist)
      if ActiveModel::Type::Boolean.new.cast checklist.should_run_today_for?(:sales)
    ...
    def create_service_manager_tasks(checklist)
      if ActiveModel::Type::Boolean.new.cast checklist.should_run_today_for?(:service)
